...
public class PGISPluginDialog extends BaseStepDialog implements StepDialogInterface {

	private static Class<?> PKG = PGISPluginMeta.class; // for i18n purposes
	
	private PGISPluginMeta input;
	...
	public PGISPluginDialog(Shell parent, Object in, TransMeta transMeta, String sname) {
		super(parent, (BaseStepMeta) in, transMeta, sname);
		input = (PGISPluginMeta) in;
	}
